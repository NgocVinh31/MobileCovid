...
export default function tintuc({ navigation }) {
    const header=()=>{
        return(
            <View>
    ...
    const renderItem = ({ item }) => (
       ...
       <TouchableOpacity onPress={() => navigation.navigate('Form2')} style={styles.mainItem_left_btn}><Image style={styles.mainItem_left} source={{ uri: item.Img}} /></TouchableOpacity>
